...
{
    public abstract class RinkLineWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RinkLineWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RinkLineWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RinkLineDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RinkLineDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RinkLineDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RinkLineDbContext, Task<T>> func)
        {
            T result;
